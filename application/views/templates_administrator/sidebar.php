  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-1">FRS <sup>ku</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Hasil Studi</a>
            <a class="collapse-item" href="buttons.html">Mata Kuliah</a>
            <a class="collapse-item" href="cards.html">Transkrip</a>
            <a class="collapse-item" href="buttons.html">Mata Kuliah</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sub-informasi Perkuliahan:</h6>
            <a class="collapse-item" href="login.html">Jadwal Perkuliahan</a>
            <a class="collapse-item" href="register.html">Materi Perkuliahan</a>
            <a class="collapse-item" href="register.html">Konsultasi</a>
          </div>
        </div>
      </li>
